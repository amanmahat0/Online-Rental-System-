  ...
  return (
    <div className="agent-listings">
      <div className="agent-listings-header">
        ...
        <div className="agent-listings-controls">
          <button
            className="agent-add-property-btn"
      ...
      <div className="agent-listings-container">
        {listings?.length > 0 ? (
          listings.map((listing, index) => (
            ...
            >
              <div className="agent-property-image">
                ...
                />
                <div
                  className={`agent-availability-badge ${
              ...
              <div className="agent-property-details">
                <h3 className="agent-property-title">{listing.title}</h3>

                <div className="agent-property-type">
                  <FaHome className="listing-agent-icon" />
                  <span>{listing.propertyType}</span>
                </div>

                <div className="agent-property-location">
                  <FaMapMarkerAlt className="listing-agent-icon" />
                  <span>
                ...
                <div className="agent-property-price">
                  <FaRupeeSign className="listing-agent-icon" />
                  <span>
                    Rs. {listing.pricePerMonth.toLocaleString()}/month
                  </span>
                </div>

                <div className="agent-property-description">
                  <FaInfoCircle className="listing-agent-icon" />
                  <span>{listing.description}</span>
                </div>

                <div className="agent-property-contact">
                  <FaPhone className="listing-agent-icon" />
          ...
          <div className="agent-no-listings">
        ...
        <div className="agent-modal-overlay">
          <div className="agent-modal">
            ...
            <form
              ...
              className="agent-property-form"
            >
              <div className="agent-form-image-upload">
                <div
                ...
                >
                  ...
                  <label
                    ...
                    className="agent-upload-image-btn"
                  >
                    Choose Image
                  </label>
                </div>
              ...
              <div className="agent-form-check">
                <input
                  type="checkbox"
                  id="isAvailable"
                  name="isAvailable"
...
export default MyListingsAgent;