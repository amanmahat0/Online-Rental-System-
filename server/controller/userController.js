...
class UserController {
  ...
  async handleUserForgotPassword(req, res) {
    try {
      ...
      const forgotPasswordMessage = await authService.forgotPassword(
        email,
        User
      );
  ...
  async handleUserChangePassword(req, res) {
    try {
      ...
      const hashedPassword = await passwordEncoderDecoder.hashPassword(
        newPassword
      );
  ...
  async handleSaveAndUnsaveProperties(req, res) {
    try {
